...
async function Settings(context) {
	...
	let securityPage = div.querySelector("#settings-security");
	let a2fPage = div.querySelector("#settings-a2f");
	...
	let editProfilePicture = div.querySelector("#editProfilePicture");
	let profileName = div.querySelector("#profile-name");
	let lang = div.querySelector("#lang");
	...
	let personalForm = div.querySelector("#personal-form");
	let editFirstName = div.querySelector("#editFirstName");
	let editLastName = div.querySelector("#editLastName");

	let emailForm = div.querySelector("#email-form");
	let editEmail = div.querySelector("#editEmail");

	let securityForm = div.querySelector("#security-form");
	let editNewPassOld = div.querySelector("#editNewPassOld");
	let editNewPass = div.querySelector("#editNewPass");
	let editNewPassConfirm = div.querySelector("#editNewPassConfirm");

	let editDisabled = div.querySelector("#editDisabled");
	let editEnabled = div.querySelector("#editEnabled");

	let btnDelete = div.querySelector("#btn-delete");
	let btnDeleteText = div.querySelector("#btn-delete-text");
	let deleteLevel = 0;
